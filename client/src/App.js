  ...
  return (
    <div className="layout">
      ...
      <Routes>
        ...
        <Route path="/login" exact element={<Login />} />
        {user ? (
          <Route path="/" element={<Main />} /> // Po zalogowaniu przechodzimy do strony Main
        ) : (
          <Route path="/" element={<Navigate replace to="/login" />} /> // W przeciwnym razie przechodzimy do strony logowania
        )}
        {user && <Route path="/list" element={<RecordList />} />}
        <Route path="/list" element={<Navigate replace to="/login" />} />
        {user && <Route path="/create" exact element={<Create />} />}
